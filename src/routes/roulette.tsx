    ...
    <>
      ...
      <ClientOnly fallback={<section aria-hidden className="h-[1287px] animate-pulse rounded-2xl bg-card xl:h-[552px]" />}>
        <div className="grid gap-3 xl:grid-cols-[280px_minmax(0,1fr)]">
          <Suspense fallback={<div className="order-2 h-64 animate-pulse rounded-xl border border-border bg-card xl:order-1 xl:h-[530px]" />}>
            <GameChat gameType="roulette" className="order-2 h-64 xl:order-1 xl:h-[530px]" />
          </Suspense>
